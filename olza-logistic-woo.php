 ...
 * Description: Olza Logistic WooCommerce is an addon that allows you to select pickup locations and delivery prices on the checkout page.
 * Version:     1.0.7
 * Author:      Grand Brand
 * License:     GPL-2.0+
...
define('OLZA_LOGISTIC_PLUGIN_VERSION', '1.0.0');
